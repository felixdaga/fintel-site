...
import type { EvalData, EvalRating, Party } from "./data";
import { DATES, PARTIES, fmtScore, fmtDate } from "./data";
  ...
  return (
    <div className="rounded-2xl border border-border bg-bg/70 p-5">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <h3 className="text-lg font-semibold text-text">Rating Rationale</h3>
                  ...
                  >
                    ...
                    <td className="py-2 px-2">
                      <span className="rounded px-1.5 py-0.5 text-xs font-medium whitespace-nowrap"
                        ...
                        }}>{rating.recommendation_rating}</span>
                    </td>
